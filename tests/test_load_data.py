...
def test_load_data_rooms_success(db_manager_mock, load_data, mock_logger):
    ...
    db_manager_mock.execute_many_query.assert_called_once_with(expected_query, expected_data)
...
def test_load_data_students_success(db_manager_mock, load_data, mock_logger):
    ...
    mock_logger.info.assert_called_with("Successfully loaded students into the database")
